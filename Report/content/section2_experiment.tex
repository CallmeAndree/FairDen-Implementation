...
\subsubsection{$\varepsilon$ tốt nhất cho mỗi $minPts$}
...
student\_address & address (2) & 5+2 & 5 & 1.4 & 0.8000 & 0.9916 \\
...
\textbf{Nhận xét:}
\begin{itemize}
    \item DCSI ổn định ở 0.80 -- thấp hơn COMPAS nhưng vẫn chấp nhận được.
    \item Config \texttt{student\_address} có Balance rất cao (0.99) -- gần đạt công bằng hoàn hảo giữa nhóm Urban và Rural.
    \item $minPts$ nhỏ (4-5) phù hợp với dataset có kích thước nhỏ (649 mẫu).
\end{itemize}
...
$minPts$ & $\varepsilon$ & DCSI & Cl. & $\varepsilon$ & DCSI & Cl. & $\varepsilon$ & DCSI & Cl. \\
\midrule
\textbf{4} & \textbf{1.4} & \textbf{0.80} & \textbf{2} & 1.4 & 0.73 & 2 & -- & -- & -- \\
\textbf{5} & 1.4 & 0.80 & 2 & \textbf{1.4} & \textbf{0.80} & \textbf{2} & \textbf{1.5} & \textbf{0.80} & \textbf{2} \\
...
\textbf{Student (\cite{cortez2008})} & \textbf{sex (2)} & \textbf{5 (+2)} & \textbf{4} & \textbf{1.4} \\
\textbf{Student (\cite{cortez2008})} & \textbf{address (2)} & \textbf{5 (+2)} & \textbf{5} & \textbf{1.4} \\
\bottomrule
\end{tabular}
