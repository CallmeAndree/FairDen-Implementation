...
Tác giả lấy mẫu 2000 điểm dữ liệu từ bộ dữ liệu và loại bỏ các bản ghi trùng lặp dựa trên các đặc trưng còn lại.
...
Tác giả sử dụng ba biến số và hai biến phân loại.
Tác giả lấy mẫu 5000 điểm dữ liệu và loại bỏ các bản ghi trùng lặp dựa trên các đặc trưng còn lại.
...
Tác giả sử dụng các thuộc tính nhạy cảm như được mô tả trong \citet{kamiran2013} và \citet{kamishima2012}, thu được 67 đặc trưng số.
Tác giả loại bỏ các điểm dữ liệu trùng lặp.
...
Tác giả sử dụng bảy đặc trưng số và lấy mẫu 5000 điểm dữ liệu, đồng thời loại bỏ các bản ghi trùng lặp.
...
Nhóm sử dụng bốn đặc trưng số và một đặc trưng phân loại.
Các thuộc tính nhạy cảm gồm: chủng tộc (race) với bốn nhóm (African-American, Caucasian, Hispanic, Other) và giới tính (sex) với hai nhóm (Male, Female).
...
Nhóm sử dụng sáu đặc trưng số và bốn đặc trưng phân loại từ 649 học sinh.
...
Nhóm sử dụng bốn đặc trưng số và lấy mẫu 5000 điểm dữ liệu.
